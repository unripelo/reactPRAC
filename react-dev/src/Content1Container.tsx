...
const Content1Container = () => {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center align-middle">
      <div className="w-2/3 h-5/6 border-4 border-black-400 bg-white rounded-xl flex-col p-10 space-y-10 flex items-center justify-center align-middle">
        <div className="bg-white p-4 rounded-lg border-4 text-2xl absolute top-40 left-60 font-serif flex md:h-18 md:max-w-screen-md">
          {text1}
        </div>
        <div
          className="bg-white border-4 rounded-lg
        flex size-90 items-center w-full text-xl overflow-y-scroll md:shrink-0 md:h-2/3 md:max-w-screen-md"
        >
